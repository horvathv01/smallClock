...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 528, ; uint32_t number_of_dso_cache_entries (0x210)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.84_name, ; name: libaot-System.Xml.ReaderWriter.dll.so
		ptr null; void* handle (0x0)
	}, ; 28
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.83_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle (0x0)
	}, ; 32
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.70_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 697280887, ; hash 0x298fa977, from name: libaot-SmallClock.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 77
	%struct.DSOCacheEntry {
		i64 709363998, ; hash 0x2a48091e, from name: aot-Plugin.Maui.Audio
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 78
	%struct.DSOCacheEntry {
		i64 719209161, ; hash 0x2ade42c9, from name: Plugin.Maui.Audio.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	%struct.DSOCacheEntry {
		i64 724020423, ; hash 0x2b27acc7, from name: aot-Plugin.Maui.Audio.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 80
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.85_name, ; name: libaot-System.dll.so
		ptr null; void* handle (0x0)
	}, ; 111
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1231589569, ; hash 0x496890c1, from name: libaot-SmallClock
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 140
	...
	%struct.DSOCacheEntry {
		i64 1347751866, ; hash 0x50550fba, from name: Plugin.Maui.Audio
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 153
	...
	%struct.DSOCacheEntry {
		i64 1688033401, ; hash 0x649d5879, from name: SmallClock
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 197
	...
	%struct.DSOCacheEntry {
		i64 1878016037, ; hash 0x6ff04025, from name: libaot-Plugin.Maui.Audio
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 220
	...
	%struct.DSOCacheEntry {
		i64 2278334965, ; hash 0x87cca1f5, from name: aot-SmallClock
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 2850402416, ; hash 0xa9e5b070, from name: aot-SmallClock.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 355
	...
	%struct.DSOCacheEntry {
		i64 3003873099, ; hash 0xb30b774b, from name: SmallClock.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 3231007712, ; hash 0xc09543e0, from name: libaot-Plugin.Maui.Audio.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.Maui.Audio.dll.so
		ptr null; void* handle (0x0)
	}, ; 411
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a599ba8e-bdb6-4d2e-b306-dd6206347427\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.smallclock\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-SmallClock.dll.so\00", align 1
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [32 x i8] c"libaot-Plugin.Maui.Audio.dll.so\00", align 1
...
@.DSOCacheEntry.70_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 1
...
@.DSOCacheEntry.83_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
@.DSOCacheEntry.84_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 1
@.DSOCacheEntry.85_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 1

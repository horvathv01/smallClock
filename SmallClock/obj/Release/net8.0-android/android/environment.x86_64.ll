...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1723292649459664324, ; hash 0x17ea5d88c715c5c4, from name: libaot-SmallClock.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 8937817740468483586, ; hash 0x7c0981e15fcef602, from name: libaot-SmallClock
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 11679065167776373499, ; hash 0xa2145fe449f2dafb, from name: SmallClock.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 331
	...
	%struct.DSOCacheEntry {
		i64 12303814146381648835, ; hash 0xaabfedc7198113c3, from name: aot-SmallClock
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 348
	...
	%struct.DSOCacheEntry {
		i64 15200572255771051982, ; hash 0xd2f347ee37e447ce, from name: aot-SmallClock.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 433
	...
	%struct.DSOCacheEntry {
		i64 15597311961198306204, ; hash 0xd874c897322d239c, from name: SmallClock
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SmallClock.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a599ba8e-bdb6-4d2e-b306-dd6206347427\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.smallclock\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-SmallClock.dll.so\00", align 16
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [32 x i8] c"libaot-Plugin.Maui.Audio.dll.so\00", align 16
...
@.DSOCacheEntry.70_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
...
@.DSOCacheEntry.83_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
@.DSOCacheEntry.84_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.85_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
